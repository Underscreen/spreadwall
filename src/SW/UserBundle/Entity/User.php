...
class User implements UserInterface, \Serializable
{
    ...
    */
    ...
    /**
     * @ORM\OneToOne(targetEntity="SW\MarketPlaceBundle\Entity\Shop", cascade={"persist"})
     * @ORM\JoinColumn(nullable=true)
     */
    private $shop;
     ...
     * Set shop
     *
     * @param \SW\MediaBundle\Entity\Shop $shop
     * @return User
     */
    public function setShop(\SW\MediaBundle\Entity\Shop $shop = null)
    {
        $this->shop = $shop;
     ...
     * Get shop
     *
     * @return \SW\MediaBundle\Entity\Shop 
     */
